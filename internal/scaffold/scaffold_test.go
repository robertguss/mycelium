...
func TestNewIdeaOfflineScaffold(t *testing.T) {
	...
	mustExist(t, inst, ".agents/skills/session/SKILL.md")
	...
	mustExist(t, inst, ".agents/skills/simmer/SKILL.md")
	mustExist(t, inst, ".agents/skills/wake/SKILL.md")
	mustExist(t, inst, ".agents/skills/clarify/SKILL.md")
	mustExist(t, inst, ".agents/skills/handoff/SKILL.md")
