...
9. No foundational choice is left to the implementer without an explicit
   bounded spike.
...
- Which research reports are supporting evidence only.

## Stop line

Do **not** begin substantive implementation while the revised specification or
final plan remains implementation-blocked. Do **not** decompose the final plan
into hundreds of coding-agent tasks inside this program.
